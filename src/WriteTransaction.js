var NullTransaction, WriteTransaction, ReactDOM,
...
WriteTransaction = (function(_super) {
  ...
  function WriteTransaction(db) {
    this.db = db;
    this.db.batchedUpdates = ReactDOM.unstable_batchedUpdates;
    this.dirtyIds = {};
    this.queued = false;
    this.traces = {};
  }
  ...
  WriteTransaction.prototype._flush = function() {
    ...
    this.dirtyIds = {};
    this.queued = false;
    return ReactDOM.unstable_batchedUpdates((function(_this) {
      return function() {
